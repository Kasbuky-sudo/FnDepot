...
| 应用 | 版本 | 架构 | 端口 | 说明 |
| --- | --- | --- | --- | --- |
| [旅行青蛙 · NAS 版](https://github.com/Kasbuky-sudo/frog-nas) | 1.0.5 | all（x86 + arm64） | 8980 | 《旅行青蛙·中国之旅》离线包的 NAS 移植：服务端权威引擎、外部推送（Webhook / 鸿蒙 MeoW）、AI Agent 接口；桌面页内打开，进度保存在应用目录，卸载重装不丢 |
...
| [ZCode](https://github.com/Kasbuky-sudo/NAS-ZCode) | 3.14.0 | all（x86 + arm64） | 8988 | Z.ai 开源的 AI 编程工作台：Agent 对话、代码工作区、内置终端跑在 NAS 上，浏览器 / 飞牛桌面直接用，关掉浏览器任务照常继续；依赖应用中心 Node.js v22，原生模块随官方预编译件分发，一个包通吃 x86_64 / arm64 |
